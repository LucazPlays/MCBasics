...
public class TphereCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage(Message.getComponent("tphere.usage", "<gradient:#ff6b6b:#ee5a24>✖ Usage: /tphere <player></gradient>"));
            return true;
        }
        ...
        teleporter.sendMessage(Message.getComponent("tphere.teleported", "<gradient:#48dbfb:#1dd1a1>✦ %target% has been teleported to you!</gradient>", "target", target.getName()));
