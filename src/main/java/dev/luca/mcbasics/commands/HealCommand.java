...
public class HealCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        target.sendMessage(Message.get("heal.healed", "You have been healed!"));

        if (target != sender) {
            sender.sendMessage(Message.get("heal.healed_other", "&a%target% has been healed!", "target", target.getName()));
        }
