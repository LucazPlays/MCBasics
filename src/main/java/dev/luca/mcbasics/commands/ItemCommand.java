...
public class ItemCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage(FormattedMessage.create("item.usage", "<gradient:#ff6b6b:#ee5a24>✖ Usage: /i <item> [amount]</gradient>"));
            return true;
        }
        ...
        if (args.length > 1) {
            try {
                ...
                sender.sendMessage(FormattedMessage.create("item.invalid_amount", "<gradient:#ff6b6b:#ee5a24>✖ Invalid amount!</gradient>"));
                return true;
            }
        }
        ...
        if (material == null) {
            sender.sendMessage(FormattedMessage.create("item.invalid_item", "<gradient:#ff6b6b:#ee5a24>✖ Invalid item!</gradient>"));
            return true;
        }
        ...
        sender.sendMessage(FormattedMessage.create("item.given", "<gradient:#48dbfb:#1dd1a1>✦ Given %amount%x %item% to your inventory!</gradient>", "amount", String.valueOf(amount), "item", displayName));
